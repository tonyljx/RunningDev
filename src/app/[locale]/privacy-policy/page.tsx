...
export default function page({}: Props) {
  return (
    <div className="prose prose-lg mx-auto">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to VividCode, 71-75 Shelton Street, Covent
        ...
        <li>
          <p>
            <strong>Website</strong> refers to RunningDev, accessible from{" "}
            <a
              href="https://next.runningpig.top/en"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://next.runningpig.top/en
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>
          <p>By email: liangjiongxin@gmail.com</p>
        </li>
        <li>
          <p>
            By visiting this page on our website:{" "}
            <a
              href="https://next.runningpig.top/en/me"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://next.runningpig.top/en/me
            </a>
          </p>
        </li>
      </ul>
