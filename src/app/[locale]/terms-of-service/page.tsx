  ...
  return (
    <div className="prose prose-lg mx-auto">
      ...
      <p>
        ...
        https://next.runningpig.top/en, you are agreeing to be bound by these
      ...
      <p>
        ...
        on VividCode's Website for personal, non-commercial transitory viewing
      ...
      <ul>
        ...
        <li>
          attempt to reverse engineer any software contained on VividCode's
          Website;
        </li>
        <li>
      ...
      <p>
        This will let VividCode to terminate upon violations of any of these
      ...
      <p>
        All the materials on VividCode's Website are provided "as is". VividCode
        makes no warranties, may it be expressed or implied, therefore negates
        all other warranties. Furthermore, VividCode does not make any
      ...
      <p>
        VividCode or its suppliers will not be hold accountable for any damages
        that will arise with the use or inability to use the materials on
        VividCode's Website, even if VividCode or an authorize representative of
      ...
      <p>
        The materials appearing on VividCode's Website may include technical,
        typographical, or photographic errors. VividCode will not promise that
        any of the materials in this Website are accurate, complete, or current.
        VividCode may change the materials contained on its Website at any time
        without notice. VividCode does not make any commitment to update the
        materials.
      </p>
      ...
      <p>
        VividCode has not reviewed all of the sites linked to its Website and is
        not responsible for the contents of any such linked site. The presence
        of any link does not imply endorsement by VividCode of the site. The use
      ...
      <p>
        VividCode may revise these Terms of Use for its Website at any time
      ...
      <p>
        Any claim related to VividCode's Website shall be governed by the laws
